...
screen main_menu():
    ...
    imagemap:
        ...
        idle "gui/butt.png"
        hover "gui/butt_act.png"

        hotspot (80, 150, 480, 100) action Start()
        hotspot (80, 290, 420, 100) action ShowMenu("load")
        hotspot (80, 430, 480, 100) action ShowMenu("preferences")
        hotspot (1650, 60, 310, 100) action Quit()
